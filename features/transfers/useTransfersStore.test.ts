...
const makeTransfer = (overrides: Partial<TransferWithDetails> = {}): TransferWithDetails => ({
  id: 1, from_account_id: 1, to_account_id: 2, amount: 100, to_amount: null,
  note: null, date: '2026-01-01', recurring_transaction_id: null, created_at: '2026-01-01T00:00:00Z',
  from_account_name: 'Cash', from_account_color: null, from_account_icon: null, from_account_currency: 'USD',
  to_account_name: 'Bank', to_account_color: null, to_account_icon: null, to_account_currency: 'USD',
  ...overrides,
});
